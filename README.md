...
Daily solutions for freeCodeCamp coding challenges. Each problem is solved in both Python 🐍 and JavaScript 📜.
...
| 28 | Roman Numeral Parser | [🐍 Python](./0028-roman-numeral-parser/roman_numeral_parser.py) | [📜 JavaScript](./0028-roman-numeral-parser/roman-numeral-parser.js) | 22.03.2026 |
| 29 | Acronym Builder | [🐍 Python](./0029-acronym-builder/acronym_builder.py) | [📜 JavaScript](./0029-acronym-builder/acronym-builder.js) | 23.03.2026 |
...
| 36 | Thermostat Adjuster | [🐍 Python](./0036-thermostat-adjuster/thermostat_adjuster.py) |[📜 JavaScript](./0036-thermostat-adjuster/thermostat-adjuster.js) | 31.03.2026 |
## 🚀 How to Use

1. Find the problem you're interested in from the table above
2. Click on the Python or JavaScript solution link
3. View the code solution
4. Run it locally or use it in your own projects
